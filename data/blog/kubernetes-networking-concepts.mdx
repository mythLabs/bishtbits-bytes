...
# Ingress in Kubernetes
  ...
  #### How Ingress Works
    ...
    Ingresss is generally installed using HELM but i'll talk about HELM in another blog, so i'll use yaml directly to install nginx-ingress.
    ...
    spec:
      ...
      - action: Allow
        ...
        - protocol: UDP
          port: 53
  ```
  *As you can judge from kind and apiVersion, this type of policy is available only if ew use calico as CNI*
